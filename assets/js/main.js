...
function sendEmail(){
    Email.send({
        ...
        Body : "Name: "+ document.getElementById('contact__name').value
            + "<br> Email: "+document.getElementById('contact__email').value
            + "<br> Subject: "+document.getElementById('contact__topic').value
            + "<br> <br> <br> <br> Message: <br> <br> "+document.getElementById('contact__message').value
    }).then(
